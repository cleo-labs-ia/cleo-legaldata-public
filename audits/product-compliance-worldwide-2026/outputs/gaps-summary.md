...
| Produit | Juridiction | Régulation | Référence | Autorité |
|---|---|---|---|---|
...
| Crème solaire | Japan | Japan Quasi-Drug (Iyakubugaiyahin) Regime — Sunscreen under PMD Act | Pharmaceuticals and Medical Devices Act (PMD Act, 薬機法) — Quasi-drugs | PMDA + Ministry of Health, Labour and Welfare (MHLW) |
| Crème solaire | Japan | Japan Quasi-Drug UV Absorber Permitted List | MHLW Quasi-Drug Ingredient Standards (医薬部外品原料規格) + MHLW Ministerial Notification | MHLW |
...
## Gaps par région (NOT_FOUND uniquement)
...
4. **Élargissement géographique critique** : 95%+ des gaps sont hors-Europe. Cibler en priorité :
   ...
   - **Amériques** (US fédéral + CA, BR, MX) — marchés régulés majeurs
   - **MENA & Afrique** (GCC, ZA, NG) — émergents avec régimes ISO/CEN qui divergent
