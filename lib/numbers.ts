...
export const NUMBERS = {
  ...
  complyHs6: 5_520, // distinct HS6 product codes
  complyRegs: 6_232, // distinct regulations in the product graph
  complyAuthorities: 1_008, // distinct enforcement authorities
  complyMarkets: 139, // markets (countries + trade blocs)
  complyCapturePct: 54, // % of mappings with a live monitoring feed
} as const;
